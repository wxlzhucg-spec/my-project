...
DEEPSEEK_MAX_TOKENS: int = int(os.environ.get("DEEPSEEK_MAX_TOKENS", "512"))
...
SHADOW_USE_SQLITE_SAVER: bool = os.environ.get("SHADOW_USE_SQLITE_SAVER", "").lower() in ("1", "true", "yes")
SHADOW_SQLITE_PATH: str = os.environ.get("SHADOW_SQLITE_PATH", "/opt/xinyu/shadow_server/data/checkpoints.db")

SHADOW_SEARCH_API_URL: str = os.environ.get("SHADOW_SEARCH_API_URL", "")
SHADOW_SEARCH_API_KEY: str = os.environ.get("SHADOW_SEARCH_API_KEY", "")
SHADOW_SEARCH_TIMEOUT_SECONDS: float = float(os.environ.get("SHADOW_SEARCH_TIMEOUT_SECONDS", "8"))
